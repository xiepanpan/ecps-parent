 ...
 * generated in the com.xiepanpan.ecps.stub package. 
...
public class ObjectFactory {
    ...
    private final static QName _PublishItemResponse_QNAME = new QName("http://service.ws.ecps.xiepanpan.com/", "publishItemResponse");
    private final static QName _PublishItem_QNAME = new QName("http://service.ws.ecps.xiepanpan.com/", "publishItem");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.xiepanpan.ecps.stub
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.ecps.xiepanpan.com/", name = "publishItemResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.ecps.xiepanpan.com/", name = "publishItem")
