            ...
            <form method="post" action="" name="" class="infor">
                ...
                <div class="box_orange">
                    <ul class="uls form">
                        <li><label>规　　格：</label>
                            <div class="pre spec">
                                <#list ebItem.ebSkuList as ebSku>
                                        <#if ebSku_index==0>
                                            <a href="javascript:void(0);" class="here" skuId="${ebSku.skuId?c}" >
                                                <#list ebSku.ebSpecValueList as ebSpecValue>
                                                ${ebSpecValue.specValue}
                                                </#list>
                                            </a>
                                        <#else>
                                            <a href="javascript:void(0);" skuId="${ebSku.skuId?c}" >
                                                <#list ebSku.ebSpecValueList as ebSpecValue>
                                                ${ebSpecValue.specValue}
                                                </#list>
                                            </a>
                        ...
                        <li><label>我 要 买：</label><a href="javascript:void(0);" class="inb sub"></a>
                            <input readonly type="text" name="" id ="quantity" value="1" class="num" size="3"/>
                            <a href="javascript:void(0);" class="inb add"></a><em id="sub_add_msg" class="red"></em>
                        </li>
                        <li class="submit">
