...
<div class="w mt ofc">
    ...
    <div class="r wr profile">
        ...
        <div class="box_orange">
            <dl class="dl_pro">
                <dt><b class="red">${username}</b>，欢迎您！<a href="${base}/editPtlUser.do" title="编辑个人资料" class="blue">编辑个人资料</a>
                </dt>
                <dd>
                    <p>总消费额：<b>￥<fmt:formatNumber value="${myTotalCash/100}" pattern="#0.00"/></b></p>
                    <p>完成订单数：<b>${mySuccessOrder}</b></p>
                    <p>我的订单：<b><a href="${base}/center/orderList.do" title="我的订单：${myOrderNum}">${myOrderNum}</a></b>
                    </p>
        ...
        <h2 class="h2 h2_filter mt"><em>我的订单</em><cite><a href="${base}/center/orderList.do" title="查看全部订单"
                                                          class="blue">查看全部订单<samp>&gt;&gt;</samp></a></cite></h2>
        <table cellspacing="0" summary="" class="tab tab4">
            ...
            <tr>
                ...
                <td class="nwp pic">
                    <ul class="uls">
                        <li>
                            <a href="#" title="摩托罗拉ME525" class="pic"><img src="../../res/img/pic/p50x50.jpg"
                                                                           alt="摩托罗拉ME525"/></a>
                            <dl>
                        ...
                        <li>
                            ...
                            <dl>
                                ...
                                <dd><span class="red">【赠品】</span>
                                    <p class="box_d bg_gray2 gray"><a href="#"
                                                                      title="1、三星（SAMSUNG）i900 3G手机（黑色）WCDMA/GSM">1、三星（SAMSUNG）i900
                                        3G手机（黑色）WCDMA/GSM</a><br/><a href="#"
                                                                     title="2、三星（SAMSUNG）i900 3G手机（黑色）WCDMA/GSM">2、三星（SAMSUNG）i900
                                        3G手机（黑色）WCDMA/GSM</a></p>
                                </dd>
                            </dl>
                        </li>
                        <li>
            ...
            <tr>
                ...
                <td>待付款</td>
                <td class="blue"><a href="javascript:void(0);" title="查看详情">查看详情</a><br/><a href="javascript:void(0);"
                                                                                            title="在线支付">在线支付</a></td>
            </tr>
            </tbody>
        </table>

        <h2 class="h2 h2_filter mt"><em>我的收藏</em><cite><a href="${base}/center/favors.do" title="查看全部订单" class="blue">查看全部收藏<samp>&gt;&gt;</samp></a></cite>
        </h2>

        <h2 class="h2 h2_ch mt"><em><a href="javascript:void(0);" title="实体商品" rel="#productTab" class="here">实体商品</a><a
                href="javascript:void(0);" title="优惠活动" rel="#eventTab">优惠活动</a></em><cite></cite></h2>
        ...
        <table cellspacing="0" summary="" id="productTab" class="tab tab4">
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/>
                    <input type="button" value="移除" onclick="singleDel('${item.id}','${item.myfavType}')"
                           class="hand btn52x21 mt"/>
                </td>
            </tr>
            <tr class="over">
                <td><a href="#" title="H7859454">H7859454</a></td>
