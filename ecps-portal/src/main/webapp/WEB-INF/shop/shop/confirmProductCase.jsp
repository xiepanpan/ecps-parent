            ...
            <div class="ofc">
                ...
                <div class="r">
                    ...
                    <dl class="total">
                        ...
                        <dd><em class="l">商品金额：</em>￥<var><fmt:formatNumber value="${totalMoney/100}"
                                                                            pattern="#0.00"/></var></dd>
                        <dd><em class="l">运费：</em>￥<var><c:out value="0.00"/></var></dd>
                        <dd class="orange"><em class="l">应付总额：</em>￥<var id="totalMoney"><fmt:formatNumber
                                value="${sku.skuPrice*buyNum }" pattern="#0.00"/></var></dd>
                        <dd class="alg_c"><input id="submitOrderID" type="submit" value="结 算" class="hand btn136x36a"
                            "/>
                        </dd>
                    </dl>
                </div>
