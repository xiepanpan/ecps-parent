            ...
            <dl class="distr">
                ...
                <dd class="box_d bg_gray2 ofc">
                    <ul class="uls form">
                        ...
                        <li id="modeLi02" style="display:none"><label>付款方式：</label><input type="checkbox"
                                                                                          name="paymentCash" value="1"/>现金&nbsp;&nbsp;<input
                                type="checkbox" name="paymentCash" value="2"/>POS刷卡&nbsp;&nbsp;<input type="checkbox"
                                                                                                      name="paymentCash"
                                                                                                      value="3"/>支票
                        </li>
                    </ul>
        ...
        <div class="box bg_white">
                ...
                <dd>
                    ...
                    <div class="box_d bg_gray2 ofc">
                        ...
                        <c:forEach items="${ebShipAddrList}" var="ebShipAddr">
                            <tr>
                                <td colspan="4">
                                    <input type="radio" value="${ebShipAddr.shipAddrId}" <c:if test="${ebShipAddr.defaultAddr==1}">checked</c:if> name="address"/>
                                    ${ebShipAddr.provText}&nbsp;${ebShipAddr.cityText}&nbsp;${ebShipAddr.distText}&nbsp;${ebShipAddr.addr}&nbsp;${ebShipAddr.zipCode}&nbsp;${ebShipAddr.shipName}&nbsp;${ebShipAddr.phone}
                                </td>
                            </tr>
                        </c:forEach>
                            <tr>
            ...
            <ul id="addAddress" class="uls form" style="display:none">
                <li><label for="username">收货人姓名：</label>
                    <span class="bg_text"><input type="text" id="username" name="shipName" vld="{required:true}"
                                                 maxLength="100" class="txt"/></span>
                ...
                <li><label for="nick">街道地址：</label>
                    <span class="bg_text"><input type="text" id="nick" name="addr" maxLength="32" vld="{required:true}"
                                                 class="txt"/></span>
                ...
                <li><label for="zipCode">邮政编码：</label>
                    <span class="bg_text"><input type="text" id="zipCode" name="zipCode" maxLength="32"
                                                 vld="{required:true}" class="txt"/></span>
                </li>
            ...
            <div class="ofc">
                ...
                <div class="r">
                    ...
                    <dl class="total">
                        ...
                        <dd class="alg_c"><input id="submitOrderID" type="submit" value="提交订单" class="hand btn136x36a"
                            "/>
                        </dd>
                    </dl>
                </div>
