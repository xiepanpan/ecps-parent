...
<div class="w ofc case">
        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                <table cellspacing="0" summary="" class="tab tab5">
                    <tr>
                        <th>您的订单号</th>
                        <td><var class="blue"><b>${ebOrder.orderNum}</b></var></td>
                        <th>应付现金</th>
                        <td><var class="red"><b>${ebOrder.orderSum}</b></var>&nbsp;元</td>
                        <th>支付方式</th>
                        <td>在线支付</td>
                    </tr>
                    <tr>
                ...
                <dd>
                    <div class="box_d bg_gray2 pb ofc">
                        ...
                        <ul class="ul x4_153x44">
                            <li><input type="radio" name="bank"/><a href="javascript:void(0);" class="inb n01"
                                                                    title="中国工商银行">中国工商银行</a></li>
                            <li><input type="radio" name="bank"/><a href="javascript:void(0);" class="inb n02"
                                                                    title="中国建设银行">中国建设银行</a></li>
                            <li><input type="radio" name="bank"/><a href="javascript:void(0);" class="inb n03"
                                                                    title="招商银行">招商银行</a></li>
                            <li><input type="radio" name="bank"/><a href="javascript:void(0);" class="inb n04"
                                                                    title="交通银行">交通银行</a></li>
                            <li><input type="radio" name="bank"/><a href="javascript:void(0);" class="inb n05"
                                                                    title="广发银行">广发银行</a></li>
                            <li><input type="radio" name="bank"/><a href="javascript:void(0);" class="inb n06"
                                                                    title="中国农业银行">中国农业银行</a></li>
                            <li><input type="radio" name="bank"/><a href="javascript:void(0);" class="inb n07"
                                                                    title="中国邮政银行">中国邮政银行</a></li>
                            <li><input type="radio" name="bank"/><a href="javascript:void(0);" class="inb n08"
                                                                    title="深圳发展银行">深圳发展银行</a></li>
                            <li><input type="radio" name="bank"/><a href="javascript:void(0);" class="inb n09"
                                                                    title="渤海银行">渤海银行</a></li>
                            <li><input type="radio" name="bank"/><a href="javascript:void(0);" class="inb n10"
                                                                    title="中信银行">中信银行</a></li>
                        </ul>
                        <h3>支持以下支付平台：</h3>
                        <ul class="ul x4_153x44">
                            <li><input type="radio" name="bank"/><a href="javascript:void(0);" class="inb n11"
                                                                    title="联动优势">联动优势</a></li>
                            <li><input type="radio" name="bank"/><a href="javascript:void(0);" class="inb n12"
                                                                    title="中国移动手机支付">中国移动手机支付</a></li>
                        </ul>
                    </div>
                </dd>
            </dl>
            ...
            <dl class="dl_msg">
                ...
                <dd class="mt inb_a"><a href="#" title="查看订单状态" class="blue">查看订单状态&gt;&gt;</a><a href="#"
                                                                                                  title="查看购物帮助"
                                                                                                  class="blue">查看购物帮助&gt;&gt;</a><a
                        href="#" title="继续购物" class="blue">继续购物&gt;&gt;</a></dd>
            </dl>
    ...
    <div class="confirm mt">
        ...
        <div class="ofc">
            ...
            <p class="okMsg"><span class="inb">您已支付成功，无需再次进行！</span><a href="#" title="继续购物"
                                                                       class="inb btn136x36b">继续购物</a></p>
