...
<div class="w ofc mt">
    ...
    <div class="r wr">
        ...
        <div class="product">
            <h2>${ebItem.itemName}<span class="gray f14">${ebItem.promotion}</span></h2>
            <div class="showPro">
                <div class="big">
                    <a id="showImg" class="cloud-zoom" href="${request_file_path}${ebItem.imgs}"
                                    rel="adjustX:10,adjustY:-1"><img title="optional title display" alt=""
                                                                     src="${request_file_path}${ebItem.imgs}">
                    </a>
                </div>
                ...
                <div class="small">
                    ...
                    <div class="smallBox">
                        <div class="smallList">
                            <a class="cloud-zoom-gallery here" title="red" href="${request_file_path}${ebItem.imgs}"
                               rel="useZoom: 'showImg', smallImage: '${request_file_path}${ebItem.imgs}'"><img
                                    alt="thumbnail 1" src="${request_file_path}${ebItem.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${request_file_path}${ebItem.imgs}"
                               rel="useZoom: 'showImg', smallImage: '${request_file_path}${ebItem.imgs}'"><img
                                    alt="thumbnail 2" src="${request_file_path}${ebItem.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${request_file_path}${ebItem.imgs}"
                               rel="useZoom: 'showImg', smallImage: '${request_file_path}${ebItem.imgs}'"><img
                                    alt="thumbnail 3" src="${request_file_path}${ebItem.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${request_file_path}${ebItem.imgs}"
                               rel="useZoom: 'showImg', smallImage: '${request_file_path}${ebItem.imgs}'"><img
                                    alt="thumbnail 4" src="${request_file_path}${ebItem.imgs}"></a>
                            <a class="cloud-zoom-gallery" title="blue" href="${request_file_path}${ebItem.imgs}"
                               rel="useZoom: 'showImg', smallImage: '${request_file_path}${ebItem.imgs}'"><img
                                    alt="thumbnail 5" src="${request_file_path}${ebItem.imgs}"></a>
                        </div>
                    </div>
            ...
            <form method="post" action="" name="" class="infor">
                <ul class="uls form">
                    ...
                    <li><label>移 动 价：</label><span class="word"><b id="skuPrice" class="f14 red mr">￥3999.00</b>(市场价:<del id="marketPrice">￥5789.00</del>)</span>
                    </li>
                ...
                <div class="box_blue">
                    <ul class="uls form pb16">
                        <li><label class="b">赠　　品：</label>
                            <div class="pre">诺基亚（NOKIA）BH-21 NFC技术 连接两台手机 白色 <samp>X 1</samp><br/>诺基亚（NOKIA）BH-21 NFC技术
                                连接两台手机 白色 <samp>X 1</samp></div>
                        </li>
                    </ul>
                </div>
                <div class="box_orange">
                    <ul class="uls form">
                        <li><label>规　　格：</label>
                            <div class="pre spec">
                                <c:forEach items="${ebItem.ebSkuList}" var="ebSku" varStatus="state">
                                    <c:choose>
                                        <%--遍历的第一个元素--%>
                                        <c:when test="${state.index==0}">
                                            <a href="javascript:void(0);" class="here" skuId="${ebSku.skuId}" skuPrice="${ebSku.skuPrice}">
                                                <c:forEach items="${ebSku.ebSpecValueList}" var="ebSpecValue">
                                                    ${ebSpecValue.specValue}
                                                </c:forEach>
                                            </a>
                                        </c:when>
                                        <c:otherwise>
                                            <a href="javascript:void(0);" skuId="${ebSku.skuId}" skuPrice="${ebSku.skuPrice}">
                                                <c:forEach items="${ebSku.ebSpecValueList}" var="ebSpecValue">
                                                    ${ebSpecValue.specValue}
                                                </c:forEach>
                                            </a>
                        ...
                        <li class="submit">
                            ...
                            <input type="button" id="addCart" value="" class="hand btn138x40b" onclick="addCart()"/>
        ...
        <div class="box bg_white ofc">
            ...
            <div id="detailTab2" style="display:none">
                ...
                <table cellspacing="0" summary="" class="tab tab7">
                    ...
                    <tbody>
                    <c:forEach items="${ebItem.paraList}" var="para">
                        <tr>
